...
| 2 | Phase F／G 的順序與範圍（展場感視覺） | 用戶提供第一人稱展場走廊參考圖。已拆解出「質感八成來自平面設計、非 3D」與七條實現限制（Safari `preserve-3d` 對 overflow、手機不成立、30 秒法則、近景圖片解析度⋯）。建議先 F 後 G，但方向未定 → 完整分析見 `.claude/knowledge/gallery-depth.md` | 2026-07-24 |
