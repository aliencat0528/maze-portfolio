...
| 2 | 展場感視覺：設計感／視覺感／色彩感／立體感四軸 | 用戶要「藝術空間的畫面與空間感」，並提供第一人稱展場走廊參考圖。設計感與空間感自由度高可直接提案；立體感＝Phase F（景深，無限制）或 G（第一人稱，七條限制）；**色彩感與根定調衝突**——D-003／MR-008 一路收斂到「中性襯托作品」「換皮會吃作品顏色」，參考圖卻是大面積疊印色塊，需在 A 維持中性／B 色彩限定非作品區／C 推翻中性 之間拍板（建議 B）→ 完整分析見 `.claude/knowledge/gallery-depth.md` | 2026-07-24 |
